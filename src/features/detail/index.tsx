...
import { useMovieVideos } from "../../hooks/movie/useMovieVideo";
...
const DetailScreen = () => {
  ...
  const { trailerKey } = useMovieVideos(Number(id));
          ...
          <div className="flex gap-3 mt-5">
            ...
            {trailerKey && (
              <button
                ...
                className="bg-black text-white px-4 py-2 rounded-lg hover:bg-grey"
              >
               Watch Trailer
              </button>
            )}
